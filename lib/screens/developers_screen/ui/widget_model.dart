...
class OBJLoaderFace {
  ...
  OBJLoaderFace() : _positions = List.filled(3, vec32.Vector3.zero()),
        _normals = List.filled(3, vec32.Vector3.zero()),
        _uvs = List.filled(3, vec32.Vector2.zero());
...
class VertexMeshInstance {
  ...
  void _cacheVertices() {
    ...
    List<vec32.Vector4> transformedPositions = List.filled(_mesh.vertexCount, vec32.Vector4.zero());
