...
import '../repo/model/food_stall_model.dart';
import 'food_stalls_viewmodel.dart';
...
class CachedFoodStallsViewModel {
  ...
  ChangeNotifier(); //0 is initial state, 1 is its in hive and read from hive, 2 is read from network call 4 is empty in network but may or may not be empty in database
